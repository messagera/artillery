...
function run(scriptPath, options) {
  ...
  app.post('/receiveMessage', function(req, res){
    ...
    var testParameters = []
    testParameters[0] = 'what day w';
    testParameters[1] = 'you like to schedule';
    testParameters[2] = 'morning, afternoon, or evening';
    testParameters[3] = 'what\'s your name';
    testParameters[4] = 'Let me see if';
...
function humanize(report) {
  ...
  fs.writeFile('assistantLog.txt', `${JSON.stringify(assistants, null, 2)}\n`, (err) => {
      if (err) throw err;
    });
